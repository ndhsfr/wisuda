	  				...
	  				<div class="panel-body">
						...
						<!-- bagian ini merupakan bagian form untuk menginput data yang akan dimasukkan ke database -->
							...
							<div class="form-group">
								...
								<!-- <span class="label label-success">MAX : 100 KARAKTER</span> -->
							</div>	
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<!-- <textarea name="t_pesan" id="t_pesan" class="form-control" placeholder="Kesan Dan pesan Selama menjadi Mhs di STIKES" required></textarea> -->
									<span class="label label-success">Untuk Kesan-Pesan MAX : 100 KARAKTER, HINDARI EMOTION</span>
								</div>
							...
							<div class="form-group">
								...
								<span class="label label-success">Foto MAX : 50.KB & HARUS JPG/JPEG</span> 
							</div>	
