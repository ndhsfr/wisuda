...
<div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Data Mhs Sudah Input Tracer Studi 
                    <small>Khusus Profesi</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="admin.php">Home Admin</a>
                    </li>
                    <li class="active">Sudah Input Tracer Studi</li>
                </ol>
            </div> <!-- / col lg 12 -->
					                    ...
					                    ?> 
					                        <tr>
					                            ...
					                            <td>
					                                ...
					                                <a href="export/srt_ket_telah_input_tracerstudi_pdf.php?nim=<?php echo $data['nim']; ?>"  title="Cetak" data-toggle="tooltip" class="btn btn-success btn-sm small" target="_blank"><span class="glyphicon glyphicon-print"></span></a>

					                                <a href="form_edit_bebas_cdc.php?nim=<?php echo $data['nim']; ?> "  title="Edit Data" data-toggle="tooltip" class="btn btn-info btn-sm small"><span class="glyphicon glyphicon-edit">Input</span></a>                               
					                            </td>      	                                          
          ...
          <div class="col-lg-12">
	            ...
	            <div class="panel panel-default">
	                    <div class="panel-heading">
	                        <h3 class="panel-title">Tabel Mhs Bebas Studi -&raquo;  CDC </h3>
	                    </div>
	            </div>
	            ...
	            <div class="table-responsive">
	                <table id="example1" class="table table-striped table-hover">
	                    ...
	                    $sql= mysqli_query($koneksi, "SELECT * FROM bebas_wisuda WHERE ta_sem='$sem_aktif[ta_sem]' and (prodi='Profesi Ners' or prodi='Profesi Bidan') ");
