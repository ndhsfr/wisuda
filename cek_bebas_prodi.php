...
<div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Data Mhs Bebas Prodi
                    <small></small>
                </h1>
                <ol class="breadcrumb">
					                    ...
					                    ?> 
					                        <tr>
					                            ...
					                            <td>
					                                ...
					                                <a href="export/srt_ket_bebas_prodi_pdf.php?nim=<?php echo $data['nim']; ?>"  title="Cetak" data-toggle="tooltip" class="btn btn-success btn-sm small" target="_blank"><span class="glyphicon glyphicon-print"></span></a>

					                                <a href="form_edit_bebas_prodi.php?nim=<?php echo $data['nim']; ?> "  title="Edit Data" data-toggle="tooltip" class="btn btn-info btn-sm small"><span class="glyphicon glyphicon-edit">Input</span></a>                               
					                            </td>      	                                          
