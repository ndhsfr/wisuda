...
if (!empty($_SESSION['userwis'])) 
{
 	if ($_SESSION['id_role'] == 1){ // jika level session adalah admin
		...
		echo '<script language="javascript">document.location="./admin.php";</script>'; // maka ke halaman home
			}
	else if ($_SESSION['id_role'] == 2){ // jika level session adalah staff
		//redirect ke halaman home2
		echo '<script language="javascript">document.location="admin.php";</script>'; // maka ke halaman home1
			}
		...
		//redirect ke halaman home3
		echo '<script language="javascript">document.location="admin.php";</script>'; // maka ke halaman home2
			}
}
?> 
