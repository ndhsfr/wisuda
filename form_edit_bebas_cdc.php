<?php $thisPage="SIM Pendaftaran Wisuda - EDIT BEBAS CDC"; ?>
<?php $title = "Sim Pendaftaran Wisuda" ?>
<?php $description = "halaman Edit CDC sistem Pendaftaran wisuda" ?>
<?php 
    ...
    <div class="row">
            <div class="col-lg-12 col-sm-12 col-md-12">
                <h1 class="page-header">Form Input
                    <small>Bebas CDC</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="admin.php">Home Admin</a>
                    </li>
                    <li class="active">Bebas CDC</li>
                </ol>
            </div> <!-- / col lg 12 -->
        ...
        <div class="col-lg-12 col-sm-12 col-md-12">
             ...
             <div class="col-lg-5 col-sm-5 col-md-5">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">                    
                        ...
                        <div class="form-group">
                            <label class="col-sm-4 control-label">Telah Input Tracerstudi</label>
                                <div class="col-sm-4">
                                    <select name="s_bebas_cdc" id="s_bebas_cdc" class="form-control" >                                      
                                        <?php  
		                                $status = $row['ket_cdc']; 
		                                if ($status == 1 ) 
		                                {
        				...
        				<div class="col-sm-2">
        					<a href="cek_bebas_cdc.php" class="btn btn-sm btn-danger" data-toggle="tooltip" title="Batal"><span class="glyphicon glyphicon-repeat"></span>Back</a>
            			</div> 
            			</div> 
            			<hr/>
						<div class="col-sm-8">
	        ...
	        { // jika tombol 'update' ditekan
	          ...
	          //  $nim     		= $_GET['nim'];
	            ...
	            $nim     		= $_POST['t_nim'];
	            $ket_cdc		= $_POST['s_bebas_cdc'];          	                            
	                  
	            
	                if ($ket_cdc != "")
	                	{
	                    // Proses ubah ke Database
	                    $sql2="update bebas_wisuda set ket_cdc='$ket_cdc' WHERE nim='$nim'";
	                        ...
	                        if(mysqli_query($koneksi, $sql2))
	                            {
	                                echo '<script type="text/javascript">
	                                    //<![CDATA[
	                                        alert ("Berhasil Edit");
	                                        window.location="cek_bebas_cdc.php?nim='.$nim.' " ;
	                                    //]]>
	                                </script>';
    ...
    <script>
		$(document).ready(function() {
		    ...
		    $('#btn-update').click(function() { 
			 ...
			 var parameter = "nim=" + $(t_nim).val() + "&ket_cdc=" + $(s_bebas_cdc).val() ; // 2variabel
				 ...
				 if ( ($(s_bebas_cdc).val() != "") )
				 {
					 ...
					 $.ajax({
				            type: 'POST', // Metode pengiriman data menggunakan POST
				          	url: 'ket_bebas/proses_update_bebas_cdc.php', // File yang akan memproses data
				         	data:  parameter,			
								...
								{ 								
									if(response.status == "sukses") // Jika Statusnya = sukses
										{ 
											...
											window.location="cek_bebas_cdc.php" ; 			
										}	
			   	...
			   	else { alert ("Pilih Dulu Sudah melakukan Input Tracer Studi Belum ? "); 
				}
