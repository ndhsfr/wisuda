...
TAHUN AKADEMIK :  <?php echo $tampil['tahun_akademik'];?> | <?php echo $tampil['semester'];?></b></td>
  ...
  <tr>
    ...
    <td>:</td>
    <td colspan="3" align="left">Ketua Program Studi <?php echo $row['prodi'];?></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="5" align="left">Bahwa Mahasiswa tersebut diatas telah menyelesaikan kegiatan akademik Program Studi dan dinyatakan </td>
  </tr>
  <tr>
    <th colspan="5" align="left">BEBAS TANGGUNGAN </th>
  </tr>
  <tr>
...
<table width="844" border="0">
  ...
  <tr>
    <td></td>
    <td></td>
    <td align="center">Program Studi <?php echo $row['prodi'];?></td>
  </tr>
  <tr>
    <td></td>
    <td></td>
