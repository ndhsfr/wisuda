...
$no_sk = $_GET['no_sk'];
  ...
  $sql2 = mysqli_query($koneksi, " select sk_wisuda.*, pendaftar_wisuda_rega.* from sk_wisuda, pendaftar_wisuda_rega where (sk_wisuda.nim=pendaftar_wisuda_rega.nim) and (sk_wisuda.no_sk='$no_sk') ") ;
...
$objPHPExcel->setActiveSheetIndex(0)
	   ->setCellValue('A1', 'REKAPITULASI PENDAFTARAN WISUDA '.$data2['program'].'| No Sk='.$no_sk.' ')
	   ->setCellValue('A2', 'TAHUN AKADEMIK : '.$TA.'|'.$semester.'  ')
	   ->setCellValue('A3', 'Prodi : '.$data2['prodi'].' ')
