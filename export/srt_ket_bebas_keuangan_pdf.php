...
<table width="843" border="0">
  <tr>
				...
				?>
    <td colspan="5" align="center"><b>SURAT KETERANGAN <br>
      BEBAS KEUANGAN <br>
...
TAHUN AKADEMIK :  <?php echo $tampil['tahun_akademik'];?> | <?php echo $tampil['semester'];?></b></td>
  ...
  <tr>
    ...
    <td>:</td>
    <td colspan="3" align="left">Bagian Administrasi Keuangan </td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="5" align="left">Bahwa Mahasiswa tersebut dinyatakan <b>BEBAS ADMINISTRASI KEUANGAN </b>(lunas/tidak punya hutang) di bagian keuangan </td>
  </tr>
  <tr>
    <th colspan="5" align="left">UNIVERSITAS MUHAMMADIYAH GOMBONG </th>
  </tr>
  <tr>
    <td colspan="5" align="left">Demikian surat keterangan ini di buat sebagaimana mestinya untuk digunakan sebagai persyaratan pendaftaran wisuda </td>
  </tr>
  <tr>
    <td colspan="5" align="left">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="5" align="left"><b>Keterangan Lain </b> : Yang bersangkutan di atas masih memilki kelebihan keuangan </td>
  </tr>
  <tr>
    <td colspan="5" align="left">Sebesar Rp. ......................, dapat dimabil setelah WISUDA</td>
  </tr>
  <tr>
    <td align="left">&nbsp;</td>
    <td>&nbsp;</td>
...
<table width="844" border="0">
  ...
  <tr>
    <td></td>
    <td></td>
    <td align="center">Administrasi Keuangan </td>
  </tr>
  <tr>
    <td></td>
    <td></td>
