...
<div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Data Mhs Bebas LPPM
                    <small>Penyerahan KTI </small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="admin.php">Home Admin</a>
                    </li>
                    <li class="active">Penyerahan KTI</li>
                </ol>
            </div> <!-- / col lg 12 -->
					                    ...
					                    ?> 
					                        <tr>
					                            ...
					                            <td>
					                                ...
					                                <a href="export/srt_ket_penyerahan_kti_lp3m_pdf.php?nim=<?php echo $data['nim']; ?>"  title="Cetak" data-toggle="tooltip" class="btn btn-success btn-sm small" target="_blank"><span class="glyphicon glyphicon-print"></span></a>

					                                <a href="form_edit_bebas_lp3m.php?nim=<?php echo $data['nim']; ?> "  title="Edit Data" data-toggle="tooltip" class="btn btn-info btn-sm small"><span class="glyphicon glyphicon-edit">Input</span></a>                               
					                            </td>      	                                          
          ...
          <div class="col-lg-12">
	            ...
	            <div class="panel panel-default">
	                    <div class="panel-heading">
	                        <h3 class="panel-title">Tabel Mhs Bebas Studi -&raquo;  LPPM </h3>
	                    </div>
	            </div>
