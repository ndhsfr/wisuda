    ...
    <div class="row">
            <div class="col-lg-12 col-sm-12 col-md-12">
                <h1 class="page-header">Form Input
                    <small>Bebas Labkes</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="admin.php">Home Admin</a>
                    </li>
                    <li class="active">Bebas Labkes</li>
                </ol>
            </div> <!-- / col lg 12 -->
        ...
        <div class="col-lg-12 col-sm-12 col-md-12">
             ...
             <div class="col-lg-5 col-sm-5 col-md-5">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">                    
                        ...
                        <div class="form-group">
                            <label class="col-sm-4 control-label">Bebas Lab-Kes</label>
                                <div class="col-sm-4">
                                    <select name="s_bebas_labkes" id="s_bebas_labkes" class="form-control" >                                      
                                        <?php  
		                                $status = $row['ket_labkes']; 
		                                if ($status == 1 ) 
		                                {
		                                	$pesan = 'OK' ; 		                                	
										} 
        				...
        				<div class="col-sm-2">
        					<a href="cek_bebas_labkes.php" class="btn btn-sm btn-danger" data-toggle="tooltip" title="Batal"><span class="glyphicon glyphicon-repeat"></span>Back</a>
            			</div> 
            			</div> 
            			<hr/>
						<div class="col-sm-8">
	        ...
	        { // jika tombol 'update' ditekan
	            ...
	            $nim     		= $_POST['t_nim'];
	            $ket_labkes		= $_POST['s_bebas_labkes'];          	                            
	                  
	            
	                if ($ket_labkes != "")
	                	{
	                    // Proses ubah ke Database
	                    $sql2="update bebas_wisuda set ket_labkes='$ket_labkes' WHERE nim='$nim'";
	                        ...
	                        if(mysqli_query($koneksi, $sql2))
	                            {
	                                echo '<script type="text/javascript">
	                                    //<![CDATA[
	                                        alert ("Berhasil Edit");
	                                        window.location="cek_bebas_labkes.php?nim='.$nim.' " ;
	                                    //]]>
	                                </script>';
    ...
    <script>
		$(document).ready(function() {
		    ...
		    $('#btn-update').click(function() { 
			 ...
			 var parameter = "nim=" + $(t_nim).val() + "&ket_labkes=" + $(s_bebas_labkes).val() ; // 2variabel

				 if ( ($(s_bebas_labkes).val() != "") )
				 {
				 
					 $.ajax({
				            type: 'POST', // Metode pengiriman data menggunakan POST
				          	url: 'ket_bebas/proses_update_bebas_labkes.php', // File yang akan memproses data
				         	data:  parameter,			
								...
								{ 								
									if(response.status == "sukses") // Jika Statusnya = sukses
										{ 
											...
											window.location="cek_bebas_labkes.php" ; 			
										}	
			   	...
			   	else { alert ("Pilih Dulu Bebas Labkes ? "); 
				}
