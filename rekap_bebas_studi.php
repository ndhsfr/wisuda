...
<div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Rekap Data Bebas Studi
                    <small></small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="admin.php">Home Admin</a>
                    </li>
                    <li class="active">Bebas Studi</li>
                </ol>
            </div> <!-- / col lg 12 -->
           ...
           <form class="form-horizontal" action="" method="post">
                     ...
                     { 
                        ...
                        $cek = mysqli_query($koneksi, "SELECT nim FROM pendaftar_wisuda_rega WHERE nim='$nim'"); 
                            ...
                            if(mysqli_num_rows($cek) == 0)
                                { 
                                    $delete = mysqli_query($koneksi, "DELETE FROM bebas_wisuda WHERE nim='$nim' "); 
                             	...
                             	{ 
                             		echo '<script type="text/javascript">
                                        //<![CDATA[
                                        alert("Data Tidak Bisa Dihapus, Karena sudah mendaftar wisuda")
				...
				?>
					<div class="col-lg-12">	
			            <div class="panel panel-default">
			                    <div class="panel-heading">
			                        <h3 class="panel-title">Tabel Mhs Bebas Studi -&raquo;  Seluruhnya </h3>
			                    </div>
			            </div>
