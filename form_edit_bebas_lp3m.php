    ...
    <div class="row">
            <div class="col-lg-12 col-sm-12 col-md-12">
                <h1 class="page-header">Form Input
                    <small>Bebas LP3M</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="admin.php">Home Admin</a>
                    </li>
                    <li class="active">Bebas LP3M</li>
                </ol>
            </div> <!-- / col lg 12 -->
        ...
        <div class="col-lg-12 col-sm-12 col-md-12">
             ...
             <div class="col-lg-5 col-sm-5 col-md-5">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">                    
                        ...
                        <div class="form-group">
                            <label class="col-sm-4 control-label">PENYERAHAN KTI</label>
                                <div class="col-sm-4">
                                    <select name="s_bebas_lp3m" id="s_bebas_lp3m" class="form-control" >                                      
                                        <?php  
		                                $status = $row['ket_lp3m']; 
		                                if ($status == 1 ) 
		                                {
        				...
        				<div class="col-sm-2">
        					<a href="cek_bebas_lp3m.php" class="btn btn-sm btn-danger" data-toggle="tooltip" title="Batal"><span class="glyphicon glyphicon-repeat"></span>Back</a>
            			</div> 
            			</div> 
            			<hr/>
						<div class="col-sm-8">
	        ...
	        { // jika tombol 'update' ditekan
	          ...
	          //  $nim     		= $_GET['nim'];
	            ...
	            $nim     		= $_POST['t_nim'];
	            $ket_lp3m		= $_POST['s_bebas_lp3m'];          	                            
	                  
	            
	                if ($ket_labkes != "")
	                	{
	                    // Proses ubah ke Database
	                    $sql2="update bebas_wisuda set ket_lp3m='$ket_lp3m' WHERE nim='$nim'";
	                        ...
	                        if(mysqli_query($koneksi, $sql2))
	                            {
	                                echo '<script type="text/javascript">
	                                    //<![CDATA[
	                                        alert ("Berhasil Edit");
	                                        window.location="cek_bebas_lp3m.php?nim='.$nim.' " ;
	                                    //]]>
	                                </script>';
    ...
    <script>
		$(document).ready(function() {
		    ...
		    $('#btn-update').click(function() { 
			 ...
			 var parameter = "nim=" + $(t_nim).val() + "&ket_lp3m=" + $(s_bebas_lp3m).val() ; // 2variabel
				 ...
				 if ( ($(s_bebas_lp3m).val() != "") )
				 {
					 ...
					 $.ajax({
				            type: 'POST', // Metode pengiriman data menggunakan POST
				          	url: 'ket_bebas/proses_update_bebas_lp3m.php', // File yang akan memproses data
				         	data:  parameter,			
								...
								{ 								
									if(response.status == "sukses") // Jika Statusnya = sukses
										{ 
											...
											window.location="cek_bebas_lp3m.php" ; 			
										}	
			   	...
			   	else { alert ("Pilih Dulu Sudah Penyerahan KTI Belum ? "); 
				}
