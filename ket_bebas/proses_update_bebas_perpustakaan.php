...
$nim			= $_POST['nim']; 
$ket_perpus 		= $_POST['ket_perpus'];
$ket_kti_perpus 	= $_POST['ket_kti_perpus'];

	$sql="update bebas_wisuda set ket_perpus='$ket_perpus', ket_kti_perpus='$ket_kti_perpus' WHERE nim='$nim'";
