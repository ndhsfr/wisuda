...
<div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Data Mhs Bebas Keuangan
                    <small></small>
                </h1>
                <ol class="breadcrumb">
					                    ...
					                    ?> 
					                        <tr>
					                            ...
					                            <td>
					                                ...
					                                <a href="export/srt_ket_bebas_keuangan_pdf.php?nim=<?php echo $data['nim']; ?>"  title="Cetak" data-toggle="tooltip" class="btn btn-success btn-sm small" target="_blank"><span class="glyphicon glyphicon-print"></span></a>

					                                <a href="form_edit_bebas_uang.php?nim=<?php echo $data['nim']; ?> "  title="Edit Data" data-toggle="tooltip" class="btn btn-info btn-sm small"><span class="glyphicon glyphicon-edit">Input</span></a>                               
					                            </td>      	                                          
          ...
          <div class="col-lg-12">
	            ...
	            <div class="panel panel-default">
	                    <div class="panel-heading">
	                        <h3 class="panel-title">Tabel Mhs Bebas Studi -&raquo;  Keuangan </h3>
	                    </div>
	            </div>
	                    ...
	                    ?> 
	                        <tr>
	                            ...
	                            <td>
	                                ...
	                                <a href="form_edit_bebas_uang.php?nim=<?php echo $data['nim']; ?> "  title="Edit Data" data-toggle="tooltip" class="btn btn-info btn-sm small"><span class="glyphicon glyphicon-edit"></span>Input</a>
	                                                                
	                            </td>      	                                          
	                            <!-- <td class="align-middle text-center"> -->
	                                <!-- <a href="edit_bebas_studi.php?nim=<?php echo $data['nim']; ?> "  title="Edit Data" data-toggle="tooltip" class="btn btn-warning btn-sm small"><span class="glyphicon glyphicon-pencil"></span>Edit</a> -->
