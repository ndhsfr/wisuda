...
<?php $description = "Halaman Ceking Bebas Studi Mahasiswa" ?>
<?php 
...
<div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Lihat Bebas Studi
                    <small>Cek Bebas Studi disini</small>
                </h1>
                <ol class="breadcrumb">
...
<!-- jQuery -->
	...
	$(document).ready(function()
	{
		...
		// 	var loadpage = "ket_bebas/view_bebas_studi.php";
